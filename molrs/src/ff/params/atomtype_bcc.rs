//! Antechamber atom-type definition rules — `ATOMTYPE_BCC.DEF`.
//!
...
//! artefact.
//!
//! Source: `$AMBERHOME/dat/antechamber/ATOMTYPE_BCC.DEF` (AmberTools).
...
/// The 4 `WILDATOM` aliases declared by `ATOMTYPE_BCC.DEF`.
#[rustfmt::skip]
...
/// `ATOMTYPE_BCC.DEF` as one typed table.
pub const ATOMTYPE_BCC: AtdTable = AtdTable {
    name: "ATOMTYPE_BCC.DEF",
    wildatoms: WILDATOMS,
    rules: RULES,
};
