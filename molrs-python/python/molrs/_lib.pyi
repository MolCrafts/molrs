...
_MetaScalar = bool | int | float | str | list[bool | int | float]

class FrameMeta:
    """Write-through ``frame.meta`` mapping (unwraps on get, coerces on set)."""

    def __getitem__(self, key: str) -> _MetaScalar: ...
    ...
    def keys(self) -> list[str]: ...
    def values(self) -> list[_MetaScalar]: ...
    def items(self) -> list[tuple[str, _MetaScalar]]: ...
    def get(self, key: str, default: Any = None) -> Any: ...
    def pop(self, key: str, *default: Any) -> Any: ...
    def popitem(self) -> tuple[str, _MetaScalar]: ...
    def clear(self) -> None: ...
    def setdefault(self, key: str, default: Any = None) -> Any: ...
    def update(self, other: Any = None, **kwargs: Any) -> None: ...
    def copy(self) -> dict[str, _MetaScalar]: ...
...
class MolRec:
    """One MolRec record: `meta` plus at least one of `frame`, `system`, `status`.
