...
class SmartsPattern:
    ...
    read them back via :meth:`find_matches_mapped`.
    """

    def __init__(self, smarts: str) -> None: ...
    def has_match(self, mol: Atomistic) -> bool: ...
    def find_matches(self, mol: Atomistic) -> List[List[int]]: ...
    def find_matches_mapped(self, mol: Atomistic) -> List[dict[int, int]]: ...
    @property
...
class Reaction:
    ...
    def apply(self, mol: Atomistic, binding: dict[int, int]) -> List[int]: ...
