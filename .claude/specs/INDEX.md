...
|---|---|---|---|---|---|
| 2026-07-06 | net-streaming | approved | molcrafts-molrs | WebSocket Frame streaming with bidirectional control (`net` feature-gated module). Sync-friendly API via background tokio runtime + crossbeam bridge; WASM-clean serialization layer (MessagePack wire types + Column::raw_bytes()). Browser clients (molvis) connect directly. |
