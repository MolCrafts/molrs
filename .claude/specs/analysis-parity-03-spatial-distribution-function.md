...
mean orientation of a target vector per voxel (the reference implementation's combined SDF + dipole
orientation).

This closes a distinct reference implementation gap: molrs's density analyzers are lab-frame and
