...
tessellation is the geometric engine behind the reference implementation's Voronoi-based analyses and is
...
- Radical Voronoi / power diagram: F. Aurenhammer, *SIAM J. Comput.* **1987**, 16,
  ...
  Rᵢ = Rⱼ).
- reference implementation Voronoi/domain/void analysis: Brehm et al., *J. Chem. Phys.* **2020**, 152,
