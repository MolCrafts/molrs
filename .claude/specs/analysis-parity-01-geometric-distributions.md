...
closes the most basic analysis-parity gap: molrs today exposes only the pairwise
...
## Domain basis
- reference implementation distribution functions: Brehm & Kirchner, *J. Chem. Inf. Model.* **2011**,
  51, 2007–2023 (reference implementation); Brehm, Thomas, Gehrke, Kirchner, *J. Chem. Phys.*
  **2020**, 152, 164105.
