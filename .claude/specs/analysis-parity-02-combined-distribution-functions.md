...
## Summary
Add **Combined Distribution Functions** — the reference implementation's single most-used analysis — to
...
silent zip-truncation). 2-D and 3-D only (the reference implementation's practical range); higher
