...
use crate::typifier::mmff::{MMFFAtomProp, MMFFEquiv, MMFFParams};
...
mod tests {
    ...
    fn test_full_mmff_xml() {
        let ff = read_forcefield_xml_str(crate::data::MMFF94_XML).unwrap();
    ...
    fn test_mmff_params_xml() {
        let params = read_mmff_params_xml_str(crate::data::MMFF94_XML).unwrap();
