...
impl MMFFTypifier {
    ...
    pub fn mmff94() -> Result<Self, String> {
        Self::from_xml_str(crate::data::MMFF94_XML)
    }
    ...
    ///
    /// Requires [`Atomistic`](crate::atomistic::Atomistic) because MMFF94
    /// typing depends on element symbols, bond orders, and ring membership.
    pub fn build(&self, mol: &crate::atomistic::Atomistic) -> Result<Potentials, String> {
